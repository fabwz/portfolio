...
export function BackgroundBlobs() {
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none fixed inset-x-0 top-0 h-[110vh] overflow-hidden"
    >
      ...
      <div
        style={PRIMARY_BLOB}
        className="absolute top-[-4%] left-[46%] h-[130px] w-[180px] -translate-x-1/2 rounded-full opacity-85 blur-[30px] md:h-[300px] md:w-[420px] md:blur-[70px]"
      />
      <div
        style={PRIMARY_BLOB}
        className="absolute top-[55%] right-[-8%] h-[200px] w-[200px] rounded-full opacity-80 blur-[45px] md:h-[460px] md:w-[460px] md:blur-[100px]"
      />
      <div
        style={SECONDARY_BLOB}
        className="absolute bottom-[2%] left-[-6%] h-[170px] w-[150px] rounded-full opacity-50 blur-[45px] md:h-[340px] md:w-[380px] md:blur-[100px]"
      />
    </div>
  );
}
